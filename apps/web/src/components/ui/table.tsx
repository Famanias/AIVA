...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn('border-t border-border bg-bg-card font-medium [&>tr]:last:border-b-0', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-border transition-colors hover:bg-bg-input/50 data-[state=selected]:bg-bg-elevated',
      className
    )}
    {...props}
  />
